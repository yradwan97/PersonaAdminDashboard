...
import { createTestmonial } from '../../../../store/testmonials/testmonialsSlice';
    ...
    <Modal isOpen={true} onClose={onClose} size="lg">
      ...
      <ModalContent borderRadius={20} paddingBlock={4} bg={theme.dark}>
        <form onSubmit={handleSubmit((values, event) => {
          dispatch(createTestmonial(event.target))
            .unwrap()
            .then(res => {
            ...
            <Stack spacing={6}>
              ...
              <FormControl>
                ...
                <Input type="file" pt={1} bg={theme.bg} color={theme.dark} border="none" borderRadius={4}
                  placeholder={t('pages.testmonials.image')} _placeholder={{ textTransform: 'capitalize' }}
                  {...register("image", {
                    required: `${t('validation.required')}`
                  })}
                />
