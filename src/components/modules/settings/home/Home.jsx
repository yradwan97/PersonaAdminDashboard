...
const Home = () => {
  ...
  const tabs = [
    { title: t("pages.settings.home.header.header"), link: "" },
    { title: t("pages.settings.home.offer.offer"), link: "offer" },
    { title: t("pages.settings.home.about.about"), link: "about" },
    { title: t("pages.settings.home.register.register"), link: "register" }
  ];
