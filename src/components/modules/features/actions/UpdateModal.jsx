...
import { updateFeature } from '../../../../store/features/featuresSlice';
    ...
    <Modal isOpen={true} onClose={onClose} size="lg">
      ...
      <ModalContent borderRadius={20} paddingBlock={4} bg={theme.dark}>
        <form onSubmit={handleSubmit((values, event) => {
          dispatch(updateFeature({ values: event.target, _id: data._id }))
            .unwrap()
            .then(res => {
          ...
          <ModalBody>
            ...
            <Stack spacing={6}>
              ...
              <FormControl>
                ...
                <Input
                  type="file" placeholder={t("pages.features.image")}
                ...
                {typeof (getValues("image")) === "string" && getValues("image") && (
                  <>
                    ...
                    <Image mt={2} src={`${baseUrl}/features/${getValues("image")}`} height="150px" objectFit="contain" />
